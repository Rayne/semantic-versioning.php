...
class SemanticVersionTest extends PHPUnit_Framework_TestCase {
	...
	public function provideValidVersions() {
		return [
			...
			['1.2.3-pre', 1, 2, 3, 'pre', ''],
			['1.2.3-pre.pre', 1, 2, 3, 'pre.pre', ''],
			['1.2.3-pre-pre', 1, 2, 3, 'pre-pre', ''],

			['1.2.3+meta', 1, 2, 3, '', 'meta'],
			['1.2.3+meta.meta', 1, 2, 3, '', 'meta.meta'],
			['1.2.3+meta-meta', 1, 2, 3, '', 'meta-meta'],

			['1.2.3-pre+meta', 1, 2, 3, 'pre', 'meta'],
			['1.2.3-pre.pre+meta.meta', 1, 2, 3, 'pre.pre', 'meta.meta'],
			['1.2.3-pre-pre+meta-meta', 1, 2, 3, 'pre-pre', 'meta-meta'],

			['0.6.0+meta-meta', 0, 6, 0, '', 'meta-meta'],
			['0.6.0+meta.meta', 0, 6, 0, '', 'meta.meta'],
	 ...
	 * @param string $meta
	 */
	public function testValidVersion($version, $major, $minor, $patch, $pre, $meta) {
